...
<div
    x-data="dashboard({
        ...
        deleteKeyUrl: @js(route('api.keys.delete')),
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center gap-1 justify-center">
                                            ...
                                            <button @click="deleteKeyAction(key.key, getDisplayName(key))" class="p-1.5 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded transition-colors" title="Delete">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6" x-data="costTracker()" x-init="init()">
                ...
                <div class="mb-6 p-4 bg-gradient-to-r from-tosca/5 to-tosca-light/5 rounded-lg border border-tosca/10 dark:from-tosca/10 dark:to-tosca-light/10">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Total Spend (<span x-text="periods[period]"></span>)</p>
                            <p class="text-3xl font-bold text-tosca" x-text="'$' + totalSpend.toFixed(2)"></p>
                        </div>
                        <div class="text-right">
                            <p class="text-sm text-gray-500 dark:text-gray-400 mb-1">Avg. Daily</p>
                            <p class="text-lg font-semibold text-gray-700 dark:text-gray-300" x-text="'$' + avgDailySpend.toFixed(2)"></p>
                        </div>
                    </div>
                </div>
                        ...
                        <template x-for="day in reversedSpend" :key="day.date">
                            <div class="group">
                                <div class="flex items-center gap-3 mb-1">
                                    <span class="w-12 text-xs text-gray-500 dark:text-gray-400" x-text="formatDate(day.date)"></span>
                                    ...
                                    <span class="w-16 text-right text-sm font-medium text-gray-700 dark:text-gray-300" x-text="'$' + day.spend.toFixed(2)"></span>
                                </div>
                            </div>
                        </template>
                    </div>
